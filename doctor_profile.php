				...
				<div class="articleSubcont">
					<div class="container mainContainer" id="mainContainer" style="margin-top:-12px;padding: 10px;">
						...
						<div style="padding: 8px;border-bottom: 0.5px solid lavender">
							...
							<div id="link" style="font-weight: 500;">Doctor's Informations</div>
						 			...
						 			<div class="detailsCont">
						 				<form class="updateProfileForm">
							 				...
							 				<div>
								 				...
								 				<div>
								 					<input class="form-control" type="text" name="uname" id="uname" value="<?php echo $row['username']; ?>" readonly>
								 				</div>
								 			</div><br>
								 			<div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".saveChanges").click(function(){
			$.ajax({
				url:"ajax/doctors/updateDoctorProfile.php",
				method:"post",
				async:false,
