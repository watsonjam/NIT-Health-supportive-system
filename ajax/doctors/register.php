...
else
{
	if(preg_match_all('/^[0-9]{9}+$/',$phone_no))
	{
        ...
        //inserting data
        $update=("update doctors set fname='$fname',mName='$mName',lname='$lname',fullName='$fullName',gender='$gender',nationality='$nationality',date_of_birth='$date_of_birth',email='$email',phone_no='$phone',details='added',date_registered='$date',time_registered='$time' where id='$doctorId'");
