...
if(isset($_POST['adminId']))
{
	...
	//------------------>>
	$select=mysqli_query($conn,"select * from users where id='$adminId'");
				...
				else
				{
					if(strlen($newPass)>=8 and strlen($newPass)<=15)
					{
						...
						else
						{
							...
							{
								$newPass=md5($newPass);
								$update=("update doctors set password='$newPass' where id='$adminId'");
...
if(isset($_POST['usersId']))
{
	...
	//------------------>>
	$select=mysqli_query($conn,"select * from users where id='$usersId'");
	$row=mysqli_fetch_array($select);
				...
				else
				{
					if(strlen($newPass)>=8 and strlen($newPass)<=15)
					{
						...
						else
						{
							...
							{
								$newPass=md5($newPass);
								$update=("update doctors set password='$newPass'");
								$result=mysqli_query($conn,$update);
								if($result)
								{
									?>
