    ...
    <div class="asideMainContainer">
        ...
        <div class="asideSubContainer"  id="asideContainer">
            <div class="asideDivControl">
                ...
                <a href="pharmacist_darshbord?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-tachometer-alt"></i><label>Darshbord</label></a>
            </div>
            <div class="asideDivControl">
                <div class="loadNofication2"></div>
                <a href="description_from_doctor?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="far fa-file-alt"></i><label>Description from the Doctor</label></a>
            </div>
            <div class="asideDivControl">
                <div class="loadNofication2"></div>
                <a href="p_drugs?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-eye"></i><label>View Drugs</label></a>
            </div>
            <div class="asideDivControl">
                <div class="displayNewSales"></div>
                <a href="sales?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-eye"></i><label>View Sales</label></a>
            </div>
            <div class="asideDivControl">
                <a href="view_sales_report?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="far fa-file-alt"></i><label>Sales Report</label></a>
            </div>            
                <div class="asideDivControl">
                <a href="pharmacist_profile?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-user"></i><label>My Profile</label></a>
            </div>
            <footer>
