...
<aside>
    ...
    <div class="asideMainContainer">
        ...
        <div class="asideSubContainer"  id="asideContainer">
            <div class="asideDivControl">
                ...
                <a href="user_darshbord?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-tachometer-alt"></i><label>Darshbord</label></a>
            </div>
            <div class="asideDivControl">
                <div class="loadNofication2"></div>
                <a href="make_appointment?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-user-plus"></i><label>Make Appointment</label></a>
            </div>
            <div class="asideDivControl">
                <div class="displayNewSales"></div>
                <a href="view_queue?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-eye"></i><label>View Queue</label></a>
            </div>
            <div class="asideDivControl">
                <a href="send_comment?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fa fa-envelope"></i><label>Send Comment</label></a>
            </div>
            <div class="asideDivControl">
                <a href="user_profile?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-user"></i><label>My Profile</label></a>
            </div>
            <footer>
    ...
    <div class="asideMainContainer asideCont2">
        ...
        <div class="asideSubContainer"  id="asideContainer">
            ...
            <div class="asideDivControl">
                <a href="d_report?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fa fa-flag"></i><label>View Report</label></a>
            </div>
                <div class="asideDivControl">
                <a href="user_profile?id=<?php echo $id; ?>&token=<?php echo $token; ?>"><i class="fas fa-user"></i><label>My Profile</label></a>
            </div>
